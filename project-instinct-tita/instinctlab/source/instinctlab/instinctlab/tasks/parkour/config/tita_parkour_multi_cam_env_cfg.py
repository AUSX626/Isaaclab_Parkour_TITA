...
class SceneCfg(InteractiveSceneCfg):
    ...
    camera1 = NoisyGroupedRayCasterCameraCfg(
    ...
    camera2 = NoisyGroupedRayCasterCameraCfg(
        # prim_path="{ENV_REGEX_NS}/Robot/torso_link",
        prim_path="{ENV_REGEX_NS}/Robot/base_link",
        mesh_prim_paths=[
            "/World/ground",
        ...
        offset=NoisyGroupedRayCasterCameraCfg.OffsetCfg(  # Tita Robot head camera nominal pose
            ...
            rot=(
                ...
                0.087,
                0.0,
            ), #(0,10,0) roll pitch yaw, larger angle, more downward view
            convention="world",
        ),
        min_distance=0.1,
        # noise
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        depth_image = ObsTerm(
            func=mdp.delayed_visualizable_multi_image,
            params={
                "data_type": "distance_to_image_plane_noised_history",
                "sensor_cfg": [SceneEntityCfg("camera1"), SceneEntityCfg("camera2")],
...
@configclass
class ParkourMultiCamEnvCfg(ManagerBasedRLEnvCfg):
    # Scene settings
