...
from instinctlab.tasks.parkour.config.tita_parkour_env_cfg import ROUGH_TERRAINS_CFG, ParkourEnvCfg
...
@configclass
class TitaParkourRoughEnvCfg(ParkourEnvCfg):
    def __post_init__(self):
        ...
        self.scene.camera.mesh_prim_paths.extend(get_link_prim_targets(TITA_LINKS))


@configclass
class TitaParkourRoughEnvCfg_PLAY(TitaParkourRoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class TitaParkourEnvCfg(TitaParkourRoughEnvCfg):
    def __post_init__(self):
        super().__post_init__()


@configclass
class TitaParkourEnvCfg_PLAY(TitaParkourRoughEnvCfg_PLAY):
    def __post_init__(self):
        super().__post_init__()
