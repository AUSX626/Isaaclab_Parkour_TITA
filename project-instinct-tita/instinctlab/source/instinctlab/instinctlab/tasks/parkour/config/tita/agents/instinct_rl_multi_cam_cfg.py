...
class EncoderConfigs:
    ...
    # encoder_1 = DepthEncoderConv2dCfg(component_names=["depth_1"])
    # encoder_2 = DepthEncoderConv2dCfg(component_names=["depth_2"])
...
@configclass
class TitaParkourMultiCamPPORunnerCfg(InstinctRlOnPolicyRunnerCfg):
    num_steps_per_env = 24
    max_iterations = 30000
    save_interval = 1000 #5000
    experiment_name = "tita_parkour_multi_cam"
    resume = False
    load_run = ""
