...
class AmassMotionCfg(AmassMotionCfgBase):
    path = os.path.expanduser("/home/cqu/Git/project-instinct/hiking-in-the-wild_Data&Model/data&model/parkour_motion_reference")
    ...
    filtered_motion_selection_filepath = os.path.expanduser("/home/cqu/Git/project-instinct/hiking-in-the-wild_Data&Model/data&model/parkour_motion_reference/parkour_motion_without_run.yaml")
