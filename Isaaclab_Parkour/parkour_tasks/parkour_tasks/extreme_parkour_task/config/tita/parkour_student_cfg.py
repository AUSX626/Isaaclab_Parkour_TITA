...
from parkour_tasks.tita_default_cfg import CAMERA_USD_CFG, CAMERA_CFG, VIEWER
from .parkour_teacher_cfg import TitaParkourTeacherSceneCfg
@configclass
class ParkourStudentSceneCfg(TitaParkourTeacherSceneCfg):
...
@configclass
class TitaStudentParkourEnvCfg(ParkourManagerBasedRLEnvCfg):
...
@configclass
class TitaStudentParkourEnvCfg_EVAL(TitaStudentParkourEnvCfg):
    viewer = VIEWER 
...
@configclass
class TitaStudentParkourEnvCfg_PLAY(TitaStudentParkourEnvCfg_EVAL):
