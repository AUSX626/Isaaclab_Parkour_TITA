...
class TeacherObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        extreme_parkour_observations = ObsTerm(
            ...
            "sensor_cfg":SceneEntityCfg("contact_forces", body_names=".*leg_4"),
...
class StudentRewardsCfg:
    reward_collision = RewTerm(
        ...
        weight=-0., 
        params={
            "sensor_cfg":SceneEntityCfg("contact_forces", body_names=["base_link", ".*leg_2", ".*leg_3"]),
        },
    )
...
# Available Body strings: 
    ...
    reward_feet_edge = RewTerm(
        ...
        weight=-1.0, 
        params={
            "asset_cfg":SceneEntityCfg(name="robot", body_names=["left_leg_4", "right_leg_4"]),
            "sensor_cfg":SceneEntityCfg(name="contact_forces", body_names=".*leg_4"),
            "parkour_name":'base_parkour',
        },
    )
    ...
    reward_hip_pos = RewTerm(
        ...
        weight=-0.5, 
        params={
            "asset_cfg":SceneEntityCfg("robot", joint_names="joint_.*_leg_1"),
        },
    )
