...
from parkour_tasks.tita_default_cfg import TitaParkourDefaultSceneCfg, VIEWER

@configclass
class TitaParkourTeacherSceneCfg(TitaParkourDefaultSceneCfg):
...
@configclass
class TitaTeacherParkourEnvCfg(ParkourManagerBasedRLEnvCfg):
    scene: TitaParkourTeacherSceneCfg = TitaParkourTeacherSceneCfg(num_envs=6144, env_spacing=1.)
    # Basic settings
...
@configclass
class TitaTeacherParkourEnvCfg_EVAL(TitaTeacherParkourEnvCfg):
    viewer = VIEWER 
...
@configclass
class TitaTeacherParkourEnvCfg_PLAY(TitaTeacherParkourEnvCfg_EVAL):
    viewer = VIEWER 
