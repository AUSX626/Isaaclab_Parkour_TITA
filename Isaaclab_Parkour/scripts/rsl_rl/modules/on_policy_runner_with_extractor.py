...
try:
    ...
    def store_code_state(log_dir, git_status_repos):
        # rsl-rl-lib>=5 removed store_code_state; code snapshot is optional.
        return []
...
class OnPolicyRunnerWithExtractor(OnPolicyRunner):
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        self.alg_cfg.pop("optimizer", None)  # IsaacLab/RSL-RL newer cfg field; unused by this project.
        ...
        self.multi_gpu_cfg = self.cfg.get("multi_gpu", None)
