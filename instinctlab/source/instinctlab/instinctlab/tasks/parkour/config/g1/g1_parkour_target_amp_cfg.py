...
class AmassMotionCfg(AmassMotionCfgBase):
    path = os.path.expanduser("~/Datasets/data&model/parkour_motion_reference")
    retargetting_func = None
    filtered_motion_selection_filepath = os.path.expanduser("~/Datasets/data&model/parkour_motion_reference/parkour_motion_without_run.yaml")
